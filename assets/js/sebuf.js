window.onload = function() {
    ...
    var back_menu = document.getElementById("backmenu"),
      ...
      beep_desc = document.getElementById("beep_desc"),
      music_frame = document.getElementById("bg_music"),
      container_desc = document.getElementById("container_desc"),
      back_to_sub = document.getElementById("back_to_sub"),
      sub_tittles = document.getElementsByClassName("item"),
    ...
    //------ Function for going to Main Menu ------//
    ...
    //------ Function to zoom item and drop-down description ------//
